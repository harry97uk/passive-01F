...
from social_media.reddit_search import reddit_search
...
def search_with_full_name(first_name,last_name,full_name,username):
    ...
    twitter_found = True if twitter_found else twitter_data.__contains__(username)
...
def recognize_username(username):
    ...
    # Sample logic:
    reddit_found = reddit_search(username)
    ...
    social_networks = {
        ...
        "Reddit": "yes" if reddit_found else "no",
